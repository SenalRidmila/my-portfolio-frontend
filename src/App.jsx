          ...
          {projects.map((project, index) => (
            <div key={index} className={`group flex flex-col rounded-2xl overflow-hidden transition duration-300 hover:-translate-y-2 border ${isDarkMode ? 'bg-card border-gray-700 hover:border-blue-500' : 'bg-white border-gray-200 hover:border-blue-500 shadow-lg'}`}>
              <div className="h-52 w-full overflow-hidden bg-gray-900 relative">
                {project.image ? (
                  <img src={project.image} alt={`${project.title} - Portfolio Project`} loading="lazy" className="w-full h-full object-contain transition duration-500" />
                ) : (
      ...
      <section id="contact" className={`py-24 px-6 text-center ${isDarkMode ? 'bg-gray-800/30' : 'bg-blue-50'}`}>
        ...
        <div className="max-w-3xl mx-auto space-y-8">
          <div className="flex flex-col items-center gap-6 mt-8">
            <a href="/Senal_Ridmila_CV.pdf" download className="w-full md:w-auto bg-gradient-to-r from-purple-600 to-blue-600 text-white px-10 py-4 rounded-full hover:from-purple-700 hover:to-blue-700 transition font-bold text-lg shadow-lg hover:shadow-purple-500/40 flex items-center justify-center gap-2">
              📄 Download My CV
            </a>
